...
public class SerialCommunication extends JFrame {
	...
	private JComboBox<String> cbVelocidadePorta;
	...
	public SerialCommunication() {
		...
		panelSerial.setBounds(3, 2, 845, 563);

		panelSerial.setLayout(null);

		lblVelocidadePorta = new JLabel("Velocidade da Porta:");
		...
		cbVelocidadePorta = new JComboBox<String>();
		cbVelocidadePorta.setBounds(210, 28, 218, 20);
		contentPane.add(cbVelocidadePorta);
	...
	public void setgetContentPane(JPanel contentPane) {
